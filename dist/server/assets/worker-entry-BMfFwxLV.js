...
const ct$1 = /* @__PURE__ */ getDefaultExportFromCjs(reactExports);
var isServer = true;
function last(arr) {
...
function ClientOnly({ children, fallback = null }) {
  return useHydrated() ? /* @__PURE__ */ jsxRuntimeExports.jsx(ct$1.Fragment, { children }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ct$1.Fragment, { children: fallback });
}
function useHydrated() {
  return ct$1.useSyncExternalStore(subscribe, () => true, () => false);
}
function subscribe() {
  return () => {
  };
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-CdEo1xYb.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-D9IWjkiy.js").then((n2) => n2.r),
